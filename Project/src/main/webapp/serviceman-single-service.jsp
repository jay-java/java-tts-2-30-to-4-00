								...
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="name" name="sname"
											value="<%=s1.getService_name()%>"> <label for="name">Service Name
											</label>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="name" name="sprice"
											value="<%=s1.getSprice()%>"> <label for="name">Service Price
											</label>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="name" name="sduration"
											value="<%=s1.getService_duration()%>"> <label for="name">Service Duration
											</label>
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" class="form-control" id="email" name="scategory"
											value="<%=s1.getService_category()%>"> <label for="email">Service Category
											</label>
									</div>
								</div>
								<div class="col-12">
